...
* 🧑‍💻 **[dorabighead](https://github.com/dorabighead)** (Lead Architect & Maintainer)
  - Architectural leadership, core system design, domain modeling, and project stewardship.
* 🤖 **[AGY (Antigravity Agent)](https://github.com/dora-exploreLab)** (Autonomous AI Co-Developer)
  - Execution harness design, fully decoupled network and storage drivers, type safety, and CI/CD pipelines.
